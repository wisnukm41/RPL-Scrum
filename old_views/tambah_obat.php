...
<head>
  ...
  <title>Tambah Data Obat || Apotek</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4 border-left-primary">
            ...
            <div class="card-body">
            <form action="./action/create_medicine.php" method="post" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="form-group col-12">
                        ...
                        <textarea  id='deskripsi' name="deskripsi" class="form-control" rows="10" required></textarea>
                    </div>
                    ...
                    <div class="form-group col-6">
                      <img src="./img/preview.png" class='img-preview' id="preview">
                    </div>
                    <div class="form-group col-12">
