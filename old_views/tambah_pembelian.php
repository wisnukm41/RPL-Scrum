...
<head>
  ...
  <title>Tambah Pembelian || Apotek</title>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4 border-left-primary">
            <div class="card-header py-3 d-flex justify-content-between">
              <h6 class="m-0 font-weight-bold text-primary">Tambah Data Pembelian Obat</h6>
              <a href="pembelian_obat.php" class="btn btn-warning">Kembali</a>
            </div>
            <div class="card-body">
            <form action="./action/create_buys.php" method="post">
                <div class="row">
                      ...
                      <table class="table table-bordered">
                        <thead>
                          <tr>
                            ...
                            <td width=20%>Harga Total <sup>*</sup></td>
